set -gx CONDA_EXE (cygpath "d:\Python\project\AI-Vtuber\Miniconda3\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "d:\Python\project\AI-Vtuber\Miniconda3")
set _CONDA_EXE (cygpath "d:\Python\project\AI-Vtuber\Miniconda3\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "d:\Python\project\AI-Vtuber\Miniconda3\python.exe")
